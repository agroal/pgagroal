...
```
# Basic database with aliases
production_db    myuser    10    5    2    prod,main,primary

# Development database with multiple aliases  
development_db   devuser   5     2    1    dev,test,staging,qa

# Legacy support with alias
new_app_db      appuser    15    8    3    legacy_app,old_db
```
