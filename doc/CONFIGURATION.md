...
| backlog | `max_connections` / 4 | Int | No | The backlog for `listen()` |
...
| METHOD | Yes      | Specifies the authentication mode for the user. `all` for all methods, otherwise `trust`, `reject`, `password` or `md5` |
